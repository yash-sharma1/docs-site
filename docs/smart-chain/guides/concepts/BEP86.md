...
This new BEP will introduce a new agovernable parameter `dynamicExtraIncentiveAmount` to the [RelayerIncentivize Contract](https://github.com/bnb-chain/bsc-genesis-contract/blob/master/contracts/RelayerIncentivize.sol). These extra  amount of BNB which will be transferred from the `SystemReward` to the bsc relayer reward pool.
...
You can see the implementation in this [PR](https://github.com/bnb-chain/bsc-genesis-contract/pull/86)
