...
Security checks are routinely and continuously planned for all parts of TSS lib implementations and future audits  will be reported to Binance Chain community.
